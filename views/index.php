        ...
        <div class="card-body p-5">
          ...
          <form id="formUsuario" name="formUsuario">
            ...
            <div class="row">
              <div class="col-md-6">
                <div data-mdb-input-init class="form-outline mb-4">
                  ...
                  <label class="form-label" for="usuario_nom1">Nombres</label>
                </div>
              </div>
              <div class="col-md-6">
                  <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="usuario_ape1" name="usuario_ape1" class="form-control form-control-lg" required />
                  <label class="form-label" for="usuario_ape1">Apellidos</label>
                </div>
              </div>
            </div>
            ...
            <div data-mdb-input-init class="form-outline mb-4">
              ...
              <label class="form-label" for="usuario_fotografia">Fotografía</label>
            </div>
